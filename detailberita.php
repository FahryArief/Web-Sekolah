        ...
        <div class="row mt-5">
            <div class="col-md-8">
                <div class="container mt-5">
                     ...
                     <div class="card">
                    <div class="card-body">
                            <h2 class="card-title">What Is Lorem Ipsum?</h2>
                            <p class="card-text"><small class="text-muted">Post on 01-11-2022  |  By Administrator</small></p>
                    </div>
                    <img src="styling/img/a.jpg" class="card-img-bottom" alt="...">
                    <div class="card-body"> <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptate, nesciunt omnis. Saepe ducimus nisi cupiditate necessitatibus quam, corporis enim? Adipisci eum unde provident ratione, officiis saepe corporis odit nulla cupiditate. Earum quidem nisi obcaecati animi illum maiores itaque asperiores excepturi voluptas, nesciunt beatae libero deleniti officia, incidunt non inventore fuga!</p></div>
            </div>
                <div class="col">
