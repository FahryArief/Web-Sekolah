...
<body class="">
    ...
    <div class="wrapper">
        ...
        <div class="body container">
            ...
            $db = mysqli_query($koneksi, "SELECT * FROM informasi WHERE jenis_informasi = 'K' ORDER BY id_informasi DESC");
            $jumlahData = mysqli_num_rows($db);
            $jumlahhalaman = ceil($jumlahData / $jumlahDataPerhalaman);
            $halamanaktif = (isset($_GET['halaman']) ? $_GET['halaman'] : 1);
            $awalData = ($jumlahDataPerhalaman * $halamanaktif) - $jumlahDataPerhalaman;
            $hasil = mysqli_query($koneksi, "SELECT * FROM informasi WHERE jenis_informasi = 'K' ORDER BY id_informasi DESC LIMIT $awalData, $jumlahDataPerhalaman");
